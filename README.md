...
trajectory** for a moving subject. Designed to be patched into HIL optimization toolkit.
...
aiding, and **Zero-Velocity Updates (ZUPT)** for dead reckoning.
...
Requires: `numpy`, `scipy` (core); `matplotlib` (was used for visualizing and initial testing of filter's accuracy, I would rather use HTML or streamlit_app going forward).
